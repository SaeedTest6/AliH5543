...
echo ""
echo "vless://${UUID}@20.90.66.7:443?encryption=none&security=tls&type=ws&sni=${SNI}&path=%2F#@Kakoolnews"
echo ""
echo "vless://${UUID}@20.103.221.187:443?encryption=none&security=tls&type=ws&sni=${SNI}&path=%2F#@Kakoolnews"
echo ""
echo "========================================"
echo ""
